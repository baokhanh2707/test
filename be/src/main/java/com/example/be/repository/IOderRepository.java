...
public interface IOderRepository extends JpaRepository<Oder,Long> {
    @Query(value = "select oder.id_pay as idPay, oder.code_pay as codePay, oder.name_pay as namePay, oder.address_pay as addressPay, oder.total_cart as totalCart,oder.create_date as createDate " +
            "from oder where oder.customer_id_customer= :id order by oder.id_pay DESC",
