...
public interface IProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query(value = "select product.amount_exist from product join cart_detail on product.id_product = cart_detail.product_id_product where cart_detail.id_card_detail= :id",countQuery = "select product.amount_exist from product join cart_detail on product.id_product = cart_detail.product_id_product where cart_detail.id_card_detail= :id",nativeQuery = true)
